  ...
  class DishesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @dish.save
          format.html { redirect_to admin_restaurant_dish_path(@dish.restaurant_id, @dish.id), notice: 'Dish was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @dish.update(dish_params)
          format.html { redirect_to admin_restaurant_dish_path(@dish.restaurant_id, @dish.id), notice: 'Dish was successfully updated.' }
    ...
    def destroy
      @dish.destroy
      respond_to do |format|
        format.html { redirect_to admin_restaurant_dishes_url, notice: 'Dish was successfully destroyed.' }
