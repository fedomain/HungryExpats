module Admin
  class CustomersController < ApplicationController
    ...
    private
      ...
      def customer_params
        params.require(:customer).permit(:first_name, :last_name, :age, :phone, :email, :username, :password, :password_confirmation, :phone_verification_code, :has_agreed, :is_active)
      end
  end
end
